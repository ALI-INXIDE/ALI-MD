...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "ALI-MD~XZF2FRDA#mtGZeyvSljMbFhOouuK1eDxuSqSWHciwkV9qVrLiMnA", // Add sess Id here especially when deploying on panels else use app.json and .env file...
